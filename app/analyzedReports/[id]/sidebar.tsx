...
import UploadResultsModal from "@/app/home/uploadResultsModal";
...
const Sidebar = async ({ email }: { email: string }) => {
  ...
  return (
    <div className=" bg-muted  hidden py-6 sm:flex gap-48 flex-col  text-black min-w-[200px] w-1/5 h-full mr-auto">
