...
const RegisterForm = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full text-[#ffffff]  active:bg-[#ffffff] bg-[#000000] border border-[#000000]  text-xl px-4 md:px-6 py-2 font-semibold rounded-lg hover:bg-[#ffffff] hover:text-black transition"
      >
        Register
      </button>
